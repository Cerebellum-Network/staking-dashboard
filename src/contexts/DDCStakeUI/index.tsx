...
export const DDCStakeContext = React.createContext<DDCStakeInterface>(
  defaultDDCStakeContext
);

export const useDDCStake = () => React.useContext(DDCStakeContext);

export const DDCStakeProvider = ({
  children,
}: {
